" Base16 Blueish (https://github.com/chriskempson/base16)
" Scheme: Arjan Frans <arjanfrans.com@gmail.com>
...
if !has('gui_running')
  if exists("g:base16_shell_path")
    execute "silent !/bin/sh ".g:base16_shell_path."/base16-blueish.".&background.".sh"
  endif
endif
